...
import edu.uci.cs142a.crux.midend.ir.core.insts.AllocateInst;
...
public final class Program implements Formattable {
    ...
    private List<AllocateInst> mGlobalVars;
    ...
    public void addGlobalVar(AllocateInst globalAllocate) {
        mGlobalVars.add(globalAllocate);
    }

    public Iterator<AllocateInst> getGlobals() {
